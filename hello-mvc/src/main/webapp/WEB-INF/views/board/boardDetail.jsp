    ...
    <div class="w-full p-6 bg-white border border-gray-200 rounded-lg shadow">
        ...
        <c:if test="${board.memberId eq loginMember.id || loginMember.role eq Role.A}">
            <div class="flex justify-end">
                <button type="button" onclick="location.href = '${pageContext.request.contextPath}/board/boardUpdate?id=${board.id}';" class="px-5 py-2.5 mt-4 mr-4 sm:mt-6 text-sm font-medium text-center text-white bg-primary-700 rounded-lg focus:ring-4 focus:ring-primary-200">
                    수정
                </button>
